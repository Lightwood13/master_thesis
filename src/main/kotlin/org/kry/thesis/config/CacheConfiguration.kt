...
class CacheConfiguration(
    ...
    fun cacheManagerCustomizer(): JCacheManagerCustomizer {
        return JCacheManagerCustomizer { cm ->
            createCache(cm, org.kry.thesis.repository.UserRepository.USERS_BY_LOGIN_CACHE)
            createCache(cm, org.kry.thesis.repository.UserRepository.USERS_BY_EMAIL_CACHE)
            createCache(cm, org.kry.thesis.domain.User::class.java.name)
            createCache(cm, org.kry.thesis.domain.Authority::class.java.name)
            createCache(cm, org.kry.thesis.domain.User::class.java.name + ".authorities")
