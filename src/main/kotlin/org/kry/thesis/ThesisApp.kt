...
import org.kry.thesis.config.ApplicationProperties
import org.kry.thesis.config.CRLFLogConverter
...
class ThesisApp(private val env: Environment) {
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<ThesisApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(ThesisApp::class.java)
